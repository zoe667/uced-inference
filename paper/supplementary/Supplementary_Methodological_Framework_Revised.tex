...
\label{tab:domain}
\small\input{tables/parameter_domain}
\end{center}
...
\small\input{tables/gp_performance}
\end{center}
...
\small\setlength{\tabcolsep}{4pt}\input{tables/ard_bounds}
\end{center}
...
are plotted; projections conceal variation in other retained dimensions.}
\end{center}
...
\small\input{tables/revalidation_2016}
\end{center}
...
\small\input{tables/revalidation_components_2016}
\end{center}
...
\small\input{tables/revalidation_2021}
\end{center}
...
\small\input{tables/revalidation_components_2021}
\end{center}
